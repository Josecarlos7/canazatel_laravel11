            ...
            <form id="confirma">
                ...
                <div class="modal-body">
                    <div class="alert alert-danger text-center">
                        ...
                        <span class="badge bg-black"><h2 id="badge_contador" style="margin:0;"></h2></span>
...
function modalConfirma(id_suc){
    ...
    $('#badge_contador').html(contador);
    $('#confirma #id_suc').val(id_suc);
    $('#modalConfirma').modal('show');
}

function asignar(){
    var id_suc = $('#confirma #id_suc').val();
    $.ajax({
